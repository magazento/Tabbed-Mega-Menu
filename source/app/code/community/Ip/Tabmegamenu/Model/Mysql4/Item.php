...
class Ip_Tabmegamenu_Model_Mysql4_Item extends Mage_Core_Model_Mysql4_Abstract {

    protected function _construct() {
        $this->_init('tabmegamenu/item', 'item_id');
    }
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object) {
        ...
        $this->_getWriteAdapter()->delete($this->getTable('tabmegamenu/item_store'), $condition);
        ...
        foreach ((array) $object->getData('stores') as $store) {
            ...
            $this->_getWriteAdapter()->insert($this->getTable('tabmegamenu/item_store'), $storeArray);
        }
        return parent::_afterSave($object);
    }
    protected function _afterLoad(Mage_Core_Model_Abstract $object) {
        $select = $this->_getReadAdapter()->select()
                        ->from($this->getTable('tabmegamenu/item_store'))
    ...
    protected function _beforeDelete(Mage_Core_Model_Abstract $object) {
        ...
        $adapter->delete($this->getTable('tabmegamenu/item_store'), 'item_id=' . $object->getId());
    }
