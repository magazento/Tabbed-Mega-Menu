...
class Ip_Tabmegamenu_Block_Admin_Category_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        $collection = Mage::getModel('tabmegamenu/category')->getCollection();
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('catalog_id', array(
            'header' => Mage::helper('tabmegamenu')->__('Category ID'),
            'align' => 'left',
            'width' => '30px',
            'index' => 'catalog_id',
        ));
        ...
        $this->addColumn('align_category', array(
            'header' => Mage::helper('tabmegamenu')->__('Align category'),
            'align' => 'left',
        ...
        $this->addColumn('action',
                array(
                    ...
                    'no_link' => true,
                    'width' => '100px',
                    'renderer' => 'tabmegamenu/admin_category_grid_renderer_action'
        ));
