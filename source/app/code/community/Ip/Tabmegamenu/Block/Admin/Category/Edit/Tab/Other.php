...
class Ip_Tabmegamenu_Block_Admin_Category_Edit_Tab_Other extends Mage_Adminhtml_Block_Widget_Form {

    protected function _prepareForm() {
        $model = Mage::registry('tabmegamenu_category');
        $form = new Varien_Data_Form();
        $this->setForm($form);
        $fieldset = $form->addFieldset('additional_form', array('legend' => Mage::helper('tabmegamenu')->__('Content Information')));
        ...
        $fieldset->addField('content_top', 'editor', array(
            'name' => 'content_top',
            'label' => Mage::helper('tabmegamenu')->__('Content Top'),
            'title' => Mage::helper('tabmegamenu')->__('Content Top'),
            'style' => 'height:16em',
        ...
        $fieldset->addField('content_bottom', 'editor', array(
            'name' => 'content_bottom',
            'label' => Mage::helper('tabmegamenu')->__('Content Bottom'),
            'title' => Mage::helper('tabmegamenu')->__('Content Bottom'),
            'style' => 'height:16em',
            'config' => $wysiwygConfig,
            'required' => false,
        ));
