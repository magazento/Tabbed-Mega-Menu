...
class Ip_Tabmegamenu_Model_Mysql4_Tab extends Mage_Core_Model_Mysql4_Abstract {

    protected function _construct() {
        $this->_init('tabmegamenu/tab', 'tab_id');
    }
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object) {
        ...
        $this->_getWriteAdapter()->delete($this->getTable('tabmegamenu/tab_store'), $condition);
        $this->_getWriteAdapter()->delete($this->getTable('tabmegamenu/tab_item'), $condition);
        $this->_getWriteAdapter()->delete($this->getTable('tabmegamenu/tab_category'), $condition);
        ...
        foreach ((array) $object->getData('stores') as $store) {
            ...
            $this->_getWriteAdapter()->insert($this->getTable('tabmegamenu/tab_store'), $storeArray);
        }
        ...
        foreach ((array) $object->getData('items') as $store) {
            ...
            $this->_getWriteAdapter()->insert($this->getTable('tabmegamenu/tab_item'), $storeArray);
        }
        ...
        foreach ((array) $object->getData('categories') as $store) {
            ...
            $this->_getWriteAdapter()->insert($this->getTable('tabmegamenu/tab_category'), $storeArray);
        }
    ...
    protected function _afterLoad(Mage_Core_Model_Abstract $object) {
        ...
        $select = $this->_getReadAdapter()->select()
                        ->from($this->getTable('tabmegamenu/tab_store'))
        ...
        $select = $this->_getReadAdapter()->select()
                        ->from($this->getTable('tabmegamenu/tab_item'))
                        ->where('tab_id = ?', $object->getId());
        if ($data = $this->_getReadAdapter()->fetchAll($select)) {
            $storesArray = array();
            foreach ($data as $row) {
		...
		$select = $this->_getReadAdapter()->select()
                        ->from($this->getTable('tabmegamenu/tab_category'))
                        ->where('tab_id = ?', $object->getId());
        if ($data = $this->_getReadAdapter()->fetchAll($select)) {
            $storesArray = array();
            foreach ($data as $row) {
    ...
    protected function _beforeDelete(Mage_Core_Model_Abstract $object) {
        ...
        $adapter->delete($this->getTable('tabmegamenu/tab_store'), 'tab_id=' . $object->getId());
    }
